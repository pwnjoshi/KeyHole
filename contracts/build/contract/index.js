...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      verify_scope_membership: async (...args_1) => {
        if (args_1.length !== 7) {
          throw new __compactRuntime.CompactError(`verify_scope_membership: expected 7 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        ...
        const result_0 = await this._verify_scope_membership_0(context,
                                                               partialProofData,
                                                               policy_id_0,
                                                               policy_commitment_0,
                                                               response_commitment_0,
    ...
    this.impureCircuits = {
      verify_scope_membership: this.circuits.verify_scope_membership
    };
  ...
  async initialState(...args_0) {
    ...
    state_0.setOperation('verify_scope_membership', new __compactRuntime.ContractOperation());
  ...
  async _verify_scope_membership_0(context,
                                   partialProofData,
                                   policy_id_0,
                                   policy_commitment_0,
                                   response_commitment_0,
