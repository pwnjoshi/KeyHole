    ...
    try {
      ...
      if (res.ok && data.success) {
        ...
        if (urlData.url) {
          ...
          // Fallback to sandbox state
          const updated = {
            ...connectedServices,
            google_workspace: { connected: true, identifier: 'sandbox-demo@enterprise.corp' }
          };
          setConnectedServices(updated);
          localStorage.setItem('keyhole_connected_services', JSON.stringify(updated));
          setSelectedServiceForModal(null);
          showSuccess('Connected Google Workspace sandbox!');
        }
      } else {
          ...
          >
            ...
            >
              ...
              {selectedServiceForModal.id === 'google_workspace' ? (
                <form onSubmit={handleSaveGoogleCredentials} className="space-y-4 pt-2">
                  <div>
                  ...
                  >
                    {isSavingCreds ? (
                      ...
                      <>
                        <span>Save &amp; Authorize Google Workspace</span>
